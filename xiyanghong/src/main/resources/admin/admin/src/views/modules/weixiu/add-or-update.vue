    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='zuke'">
                    <el-form-item class="select" v-if="type!='info'"  label="租客" prop="zukeId">
                        <el-select v-model="ruleForm.zukeId" filterable placeholder="请选择租客" @change="zukeChange">
                            <el-option
                ...
                <el-col :span="24" v-if="sessionTable !='zuke' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='zuke' ">
                    <el-form-item class="input" v-if="type!='info'"  label="单元号" prop="danyuanValue">
                        <el-input v-model="zukeForm.danyuanValue"
                                  placeholder="单元号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="单元号" prop="danyuanValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='zuke' ">
                    <el-form-item class="input" v-if="type!='info'"  label="使用" prop="shiyongValue">
                        <el-input v-model="zukeForm.shiyongValue"
                                  placeholder="使用" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="使用" prop="shiyongValue">
                            <el-input v-model="ruleForm.shiyongValue"
                                      placeholder="使用" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="zukeId" name="zukeId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修名称" prop="weixiuName">
                       <el-input v-model="ruleForm.weixiuName"
                                 placeholder="维修名称" clearable  :readonly="ro.weixiuName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="维修名称" prop="weixiuName">
                           <el-input v-model="ruleForm.weixiuName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="维修类型" prop="weixiuTypes">
                        <el-select v-model="ruleForm.weixiuTypes" placeholder="请选择维修类型">
                            <el-option
                                v-for="(item,index) in weixiuTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="维修类型" prop="weixiuValue">
                        <el-input v-model="ruleForm.weixiuValue"
                            placeholder="维修类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="申请详情" prop="weixiuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.weixiuContent" label="申请详情" prop="weixiuContent">
                            <span v-html="ruleForm.weixiuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="role == '管理员'">
                    <el-form-item class="select" v-if="type!='info'"  label="是否维修" prop="weixiuTypes">
                        <el-select v-model="ruleForm.shifouTypes" placeholder="请选择是否维修">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否维修" prop="shifouValue">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   weixiuContent: [
                              { required: true, message: '申请详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=weixiu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.weixiuTypesOptions = data.data.list;
                    }
                });
                this.$http({
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='zukeId'){
                          this.ruleForm.zukeId = obj[o];
                          this.ro.zukeId = true;
                          continue;
                      }
                      if(o=='weixiuName'){
                          this.ruleForm.weixiuName = obj[o];
                          this.ro.weixiuName = true;
                          continue;
                      }
                      if(o=='weixiuTypes'){
                          this.ruleForm.weixiuTypes = obj[o];
                          this.ro.weixiuTypes = true;
                          continue;
                      }
                      if(o=='weixiuContent'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.zukeChange(data.data.zukeId)
                        //解决前台上传图片后台不显示的问题
