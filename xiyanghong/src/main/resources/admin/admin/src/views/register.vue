    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">夕阳红公寓注册</h1>
                <el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
                        ...
                        <el-form-item label="租客姓名" class="input" v-if="tableName=='zuke'">
                            <el-input v-model="ruleForm.zukeName" autocomplete="off" placeholder="租客姓名"  />
                        </el-form-item>
                        <el-form-item label="租客手机号" class="input" v-if="tableName=='zuke'">
                            <el-input v-model="ruleForm.zukePhone" autocomplete="off" placeholder="租客手机号"  />
                        </el-form-item>
                        <el-form-item label="租客身份证号" class="input" v-if="tableName=='zuke'">
                            <el-input v-model="ruleForm.zukeIdNumber" autocomplete="off" placeholder="租客身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='zuke'">
                            <el-input v-model="ruleForm.zukeEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
                        <el-form-item label="单元号">
                            <el-select v-model="ruleForm.danyuanTypes" placeholder="请选择单元号">
                                <el-option
        ...
        methods: {
            ...
            login() {
                            ...
                            if(this.ruleForm.repetitionPassword != this.ruleForm.password){
                             ...
                             if('zuke' == this.tableName && this.ruleForm.zukePhone&&(!this.$validate.isMobile(this.ruleForm.zukePhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.zukeIdNumber)&& 'zuke'==this.tableName){
                                this.$message.error('租客身份证号不能为空');
                                return
                            }
                            if('zuke' == this.tableName && this.ruleForm.zukeEmail&&(!this.$validate.isEmail(this.ruleForm.zukeEmail))){
