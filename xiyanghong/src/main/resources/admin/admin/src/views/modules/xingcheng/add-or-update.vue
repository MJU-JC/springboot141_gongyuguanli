    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="zukeId" name="zukeId" type="hidden">
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xingchengPhoto" label="健康码" prop="xingchengPhoto">
                        <file-upload
                            tip="点击上传健康码"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xingchengPhoto" label="健康码" prop="xingchengPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="行程轨迹" prop="gonggaoName">
                       <el-input v-model="ruleForm.gonggaoName"
                                 placeholder="行程轨迹" clearable  :readonly="ro.gonggaoName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="行程轨迹" prop="gonggaoName">
                           <el-input v-model="ruleForm.gonggaoName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="xingchengContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xingchengContent" label="备注" prop="xingchengContent">
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='xingchengPhoto'){
                          this.ruleForm.xingchengPhoto = obj[o];
                          this.ro.xingchengPhoto = true;
                          continue;
                      }
                      if(o=='gonggaoName'){
                      ...
                      if(o=='xingchengContent'){
                          this.ruleForm.xingchengContent = obj[o];
                          this.ro.xingchengContent = true;
                          continue;
                      }
                      if(o=='insertTime'){
